...
const DATA = ['Provinsi', 'Kabupaten/Kota', 'Kecamatan'];

const TentukanIdemu = () => {
  return (
    <>
      <Text style={styles.title}>💭 Tentukan Ide Produk UMKM</Text>
      <View style={styles.container}>
        <Text style={styles.desc}>Masukkan lokasi usaha</Text>
        {DATA.map((_, idx) => {
          return (
